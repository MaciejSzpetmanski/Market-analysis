...
# Funkcja wykrywająca formację "death cross"
def wykryj_death_cross(dane, okres_szybki=50, okres_wolny=200):
    """
    Wykrywa formację "death cross" w dostarczonym DataFrame.
